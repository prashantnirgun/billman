     ...
     <?php echo validation_errors(); ?>
        ...
        <div  class=" col-md-3 col-md-offset-9">
            ...
            <p id="profile-name" class="profile-name-card"></p>
                     ...
                     <form action="<?php echo base_url();?>login_check" method="POST" id="login_form">
                        <input type="hidden" name="pid" id="pid" value="<?php echo $pid; ?>">
                        <div class="form-group">
                          <input type="text" name="name" id="name" class="form-control"
                          placeholder="User Name / Email / Mobile" value ="<?php echo $name; ?>" required>
                          </div>
                        <div class="form-group">
                          <input type="password" name="password" id="password" class="form-control"
                          placeholder="New Password" value ="<?php echo $password; ?>" required>
                        </div>
                      <?php if($pid){ ?>
                      <div class="form-group">
                      ...
                      <div class="col-md-6">
                      <a href="<?php echo base_url();?>login/forgot_view" class="forgot-password">Forgot password</a>
                      </div>
                      
                      </div>
                      </div>
                   <div class="form-group">
                    <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit" id="button_login">Sign in</button>
                </div>
                 </form><!-- /form -->
