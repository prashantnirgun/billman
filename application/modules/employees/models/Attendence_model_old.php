...
class Attendence_model extends MY_model
{
	...
	public function __construct()
	{
     ...
     public function retrive_attendence($id,$in_date,$out_date)
   {
    ...
    public function get_all_by_fk($id)
     {
       //var_dump($date_condition);
       $sql = "SELECT id,employee_id,date_format($this->table .present_date ,'%M-%Y') AS            
