...
class Supplier extends Admin_Crud_Controller 
{
 	...
 	public function index()
 	{
		...
		$account_group_id =  $this->common_model->get_by_column_where('account_group','id','name = "sundry creditors"' );
		...
		$data 	= $this->set_view_data('Supplier','Supplier',
					$result, 'supplier/home_view', TRUE);
